  ...
  return (
    <div>
      ...
      <section className="py-20 px-4 md:px-8">
        <div className="max-w-5xl mx-auto bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-3xl border border-blue-500/30 p-8 md:p-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Start Your Journey?</h2>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Software development offers endless opportunities for creativity, problem-solving, and career growth. Begin
            your path today!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="https://www.jobbank.gc.ca/career-planning/jobs/2174"
              target="_blank"
            ...
            <Link
              href="https://www.myblueprint.ca/peel"
              target="_blank"
              className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-slate-800 text-white font-medium hover:bg-slate-700 transition-colors border border-slate-600"
            >
